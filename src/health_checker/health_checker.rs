...
impl HealthChecker {
    ...
    pub fn run_health_answerer(&self, address: &str, timeout_in_sec: u64) {
        ...
        for stream in listener.incoming() {
            ...
            self.answer_health_messages(&stream, HealthMsg::Ping, HealthMsg::Pong, 0);
    ...
    pub fn run_health_checker(&self, address: &str, timeout_in_sec: u64, sec_between_requests: u64) {
        ...
        self.answer_health_messages(&stream, HealthMsg::Pong, HealthMsg::Ping, sec_between_requests);
        let _ = stream.shutdown(Shutdown::Both);
    }

    fn answer_health_messages(&self, mut stream: &TcpStream, expected: HealthMsg, answer: HealthMsg, sleep_before_answer_sec: u64) {
        ...
        while !stop_answering {
            ...
            match reader.read_exact(&mut buffer) {
                ...
                Err(ref e) if e.kind() == std::io::ErrorKind::UnexpectedEof => {
                    ...
                    // TODO: llamar a funcion pasada por parametro tipo handle_eof. No decidir el stop answering aca... o si?
                    stop_answering = true;
                }
